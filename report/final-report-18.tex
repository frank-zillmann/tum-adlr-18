...
\subsection{Iterative Improvement and Challenges}
...
\caption{Evaluation reward curves of final run (light blue) and longer run (dark blue) without birdview image and below-table voxel exclusion.}
